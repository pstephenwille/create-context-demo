describe('Filters the Datagrid', () => {
    ...
    beforeEach(() => {
        ...
        cy.get('#drawer-0').click();
    });

    it.only('Selecting multiple filters displays the correct item', () => {
        /* name */
    ...
    it('Displays the filtered item from URL params', () => {
        ...
        cy.get('#name').should('have.value', 'prometheus-archive');
        cy.get('#alert_email').should('have.value', 'oe@climate.com');
        cy.get('#team').should('have.value', 'sre');
